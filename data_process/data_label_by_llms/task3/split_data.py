...
# 使用此函数分割文件
file_paths = ["output/env/is_env_true.jsonl", "output/gov/is_gov_true.jsonl", "output/soc/is_soc_true.jsonl"]
output_folders = ["split_data_9class/env", "split_data_9class/gov", "split_data_9class/soc"]

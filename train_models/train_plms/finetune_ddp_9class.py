...
def setup_logging(model_name, log_file='training.log'):
    log_dir = os.path.join('model/nine_class', model_name, 'log')
    ...
    def __init__(self, file_path, tokenizer):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                self.data.append((item['text'], label_map[item['sub_label']]))
...
def main():
    ...
    if args.model_type == 'bert':
        ...
        model = RobertaForSequenceClassification.from_pretrained(model_name, num_labels=9).to(device)
        tokenizer = RobertaTokenizer.from_pretrained(model_name)
    ...
    train_dataset, val_dataset, test_dataset = load_datasets(
        tokenizer,
        'nine_class_dataset/stratified/81_09_10/train.jsonl',
        'nine_class_dataset/stratified/81_09_10/val.jsonl',
        'nine_class_dataset/stratified/81_09_10/test.jsonl'
    )
    ...
    best_accuracy = 0.0
    best_model_path = f"model/nine_class/{model_name}/best_model"
